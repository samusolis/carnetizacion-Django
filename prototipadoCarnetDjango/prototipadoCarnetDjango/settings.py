"""
Django settings for prototipadoCarnetDjango project.
...
SECRET_KEY = 'django-insecure-5(6&fcjb7k7^!6l7p7r3$@*=p$9%qi3e1)(q+tt_$+**nz=#+o'
...
ROOT_URLCONF = 'prototipadoCarnetDjango.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'carnetdjango',  # No uses '.db' en el nombre si es MySQL
        'USER': 'root',
        'PASSWORD': '',
        'HOST': 'localhost',
        'PORT': '3306',
        'OPTIONS': {
            'charset': 'utf8mb4',  
            'init_command': "SET innodb_strict_mode=1; SET default_storage_engine=InnoDB;"
        }
    }
}
...
SESSION_SAVE_EVERY_REQUEST = True  # Guarda sesión en cada request
SESSION_EXPIRE_AT_BROWSER_CLOSE = True # No expira al cerrar el navegador
>>>>>>> a2bdbbca8031390ff6252a5f1b0541b2a7dcf3fb
